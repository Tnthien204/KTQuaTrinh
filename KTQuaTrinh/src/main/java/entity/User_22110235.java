...
@Entity
@Table(name="users")
@NamedQuery(name="User_22110235.findAll", query="SELECT u FROM User_22110235 u")

public class User_22110235 implements Serializable {
