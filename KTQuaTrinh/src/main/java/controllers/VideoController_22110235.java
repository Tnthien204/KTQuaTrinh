...
import services.impl.VideoServiceImpl_22110235;
@MultipartConfig()
...
public class VideoController_22110235 extends HttpServlet {

	private static final long serialVersionUID = 1L;
	public IVideoService_22110235 vidService = new VideoServiceImpl_22110235();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (url.contains("/admin/videos")) {
			...
			ICategoryService_22110235 categoryService_22110235 = new CategoryServiceImpl_22110235();
		    List<Category> categories = categoryService_22110235.findAll(); 
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		CategoryServiceImpl_22110235 c = new CategoryServiceImpl_22110235();
