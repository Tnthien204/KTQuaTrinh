...
public class MyAccountController_22110235 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    if (JakartaServletFileUpload.isMultipartContent(req)) {
	        ...
	        upload.setFileSizeMax(Constant_22110235.MAX_FILE_SIZE);
			upload.setSizeMax(Constant_22110235.MAX_REQUEST_SIZE);
	    ...
	    if (session != null && session.getAttribute("account") != null) {
	        User_22110235 i = (User_22110235) session.getAttribute("account");
	        
	        User_22110235 u = service.findByUsername(i.getUsername());
	        ...
	        if (!u.getPhone().equals(i.getPhone())) {
	            ...
	            if (service.findByPhone(u.getPhone()) != null) {
	                ...
	                User_22110235 updatedUser = service.findById(u.getUserid());
	                req.setAttribute("account", updatedUser);
	                req.getRequestDispatcher(Constant_22110235.Path.MyAccount).forward(req, resp);
	                return;
	            }
	        }
